    ...
    private JPanel createClientPanel() {
        ...
        btnSave.addActionListener(e -> {
            try {
                ...
                boolean isNewClient = selectedClient == null || selectedClient.getId() != id;
                if (isNewClient && system.isIdTaken(id)) {
                ...
                JOptionPane.showMessageDialog(this,
                        isNewClient ? "Cliente cadastrado com sucesso!" : "Cliente atualizado com sucesso!");
                txtName.setText("");
                txtId.setText("");
                txtEmail.setText("");
    ...
    private JPanel createDeliveryManPanel() {
        ...
        btnSave.addActionListener(e -> {
            try {
                ...
                DeliveryMan selectedDeliveryMan = deliveryManList.getSelectedValue();
                boolean isNewDeliveryMan = selectedDeliveryMan == null || selectedDeliveryMan.getId() != id;
                if (isNewDeliveryMan && system.isIdTaken(id)) {
                    JOptionPane.showMessageDialog(this, "ID já está em uso!", "Erro", JOptionPane.ERROR_MESSAGE);
                    return;
                }
                ...
                JOptionPane.showMessageDialog(this,
                        isNewDeliveryMan ? "Entregador cadastrado com sucesso!" : "Entregador atualizado com sucesso!");
                txtName.setText("");
                txtId.setText("");
                txtEmail.setText("");
                deliveryManList.clearSelection();
                mainFrame.refreshState();
            } catch (NumberFormatException ex) {
                JOptionPane.showMessageDialog(this, "ID inválido!", "Erro", JOptionPane.ERROR_MESSAGE);
            }
    ...
    private JPanel createRestaurantPanel() {
        ...
        btnSave.addActionListener(e -> {
            try {
                ...
                boolean isNewRestaurant = selectedRestaurant == null || selectedRestaurant.getId() != id;
                if (isNewRestaurant && system.isIdTaken(id)) {
                    JOptionPane.showMessageDialog(this, "ID já está em uso!", "Erro", JOptionPane.ERROR_MESSAGE);
                    return;
                }
                ...
                JOptionPane.showMessageDialog(this,
                        isNewRestaurant ? "Restaurante cadastrado com sucesso!" : "Restaurante atualizado com sucesso!");
                txtName.setText("");
                txtId.setText("");
                txtEmail.setText("");
                txtNickname.setText("");
